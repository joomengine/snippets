### JCB! Snippet
# [Button Group](https://getuikit.com/docs/button)
...
### Usage
> To create a button group, add the .uk-button-group class to a  element around the buttons. That's it! No further markup needed.
